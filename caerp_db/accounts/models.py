...
class AccProformaInvoiceMasterView(caerp_base):
    __tablename__ = 'off_view_proforma_invoice_master'
    ...
    net_amount                     = Column(Float, nullable=True)
    proforma_invoice_status_id     = Column(Integer, nullable=False)
    proforma_invoice_status        = Column(String(50), nullable= False)
...
class AccProformaInvoiceDetailsView(caerp_base):
    __tablename__ = 'off_view_proforma_invoice_details'

    id                         = Column(Integer, primary_key=True, autoincrement=True)
    proforma_invoice_master_id = Column(Integer, nullable=False)
    service_type                = Column(Enum('CONSULTATION', 'NON_CONSULTATION', 'GOODS'), nullable=False, default='no' )
    service_goods_master_id     = Column(Integer, nullable=True)
    service_goods_name          = Column(String(100), nullable=True)
    hsn_sac_id                  = Column(Integer, nullable=True)
    hsn_sac_code                = Column(String(50), nullable=True)
    sku_code_id                 = Column(Integer, nullable=True)
    ...
    additional_discount_percentage  = Column(Float, nullable=True)
    additional_discount_amount      = Column(Float, nullable=True)

    taxable_amount              = Column(Float, nullable=True)
    igst_percent                = Column(Float, nullable=True)
    igst_amount                 = Column(Float, nullable=True)
    cgst_percent                = Column(Float, nullable=True)
    cgst_amount                 = Column(Float, nullable=True)
    sgst_percent                = Column(Float, nullable=True)
    sgst_amount                 = Column(Float, nullable=True)
    cess_percent                = Column(Float, nullable=True)
    cess_amount                 = Column(Float, nullable=True)
    additional_cess_percent     = Column(Float, nullable=True)
    additional_cess_amount      = Column(Float, nullable=True)
...
class AccTaxInvoiceMasterView(caerp_base):
    ...
    tax_invoice_status        = Column(String(50), nullable= False)
...
class AccQuotationDetailsView(caerp_base):
    __tablename__ = 'off_view_quotation_details'
