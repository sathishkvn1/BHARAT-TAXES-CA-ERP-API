...
class  saleMaster(caerp_base):
    ...
    tax_period_year = Column(DateTime, nullable=False)
    ...
    amended_tax_period_year = Column(DateTime, nullable=True)
    amended_tax_period_month = Column(Integer, nullable=True)
    ...
    reverse_charge = Column(Integer, nullable=False)
