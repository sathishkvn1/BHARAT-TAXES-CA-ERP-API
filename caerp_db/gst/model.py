...
class  saleMaster(caerp_base):
    ...
    amended_invoice_date = Column(Date, nullable=False)
    amended_tax_period_year = Column(DateTime, nullable=False)
    amended_tax_period_month = Column(Integer, nullable=False)
